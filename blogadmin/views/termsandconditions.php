...
require_once "../dblayer/termsandconditionsOps.php";
...
<body>
            ...
            <div class="row gutters-sm">
                <div class="col-md-12">
                    <div class="form-group">
                        <h3></h3>
                        <?php
                        $term = DBterms::gettermsandconditions();
    ...
    <div class="modal fade" id=addModal tabindex=-1 role=dialog aria-hidden=true>
        <div class="modal-dialog modal-xl">
            <form method="post" id="user_form" action="../controller/termsandconditionsController.php">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="modal_title">Terms And Conditions</h4>
    ...
    <div class="modal fade" id=editModal tabindex=-1 role=dialog aria-hidden=true>
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <form method="POST" action="../controller/termsandconditionsController.php">
