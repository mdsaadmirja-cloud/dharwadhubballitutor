...
$batches = $batchModel->getAll($_SESSION['user_id']);
$syllabi = $syllabusModel->getAllSyllabi($_SESSION['user_id']);
...
function manageStudents(batchId) {
    ...
    success: function(response) {
            ...
            if (response.success) {
                ...
                $('#student_search').parent().hide(); // Hide manual search, as live-search is provided
